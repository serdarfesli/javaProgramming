...
public class SalaryCalculator {
    ...
    public static void main(String[] args) {
        int hourlyRate, weeklyHours,stateTax, salaryBeforeTax, salaryAfterTax, federalTax, totalTax;
        ...
        stateTaxRate = 0.06;
        federalTaxRate = 0.26;
        salaryBeforeTax = hourlyRate * weeklyHours * 52; //Gross Pay
        federalTax = (int) (salaryBeforeTax * federalTaxRate); //federal tax
        stateTax = (int) (salaryBeforeTax * stateTaxRate); //state tax
        totalTax = federalTax + stateTax; //Total Tax
        salaryAfterTax = salaryBeforeTax - totalTax; //Net Income
